defmodule Issues.TableFormatter do
  ...
  We calculate thw width of each column to fit the longest element
  in that column.
  """
  ...
  @doc"""
  Return a binary (string) version of your parameter.
  ## Example
  ...
  ## Example
      iex> data = [ ["cat", "wombat", "elk"], ["momgoose", "ant", "gnu"]]
